...
1. **📅 Interactive Weekly Timetable**: View by **Class** (14 classes), **Teacher** (36 faculty), or **Classroom** (20 rooms, including normalized gymnasium "Sport Zal") with version switcher across 8 terms. Features automatic multi-period spanning (`colSpan = 2`) for Grade 10 & 11 elective block lessons (A10, B10, A11, B11) with zero schedule gaps. Includes a full 24-hour day schedule controller (scrubbing from 00:00 to 23:59 with fine-tuning steppers, day-of-week simulator, and milestone presets), real-time timeline indicator, live Tashkent clock (UTC+5), and interactive lesson inspector modal with accurate period timings.
