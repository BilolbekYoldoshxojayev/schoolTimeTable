...
1. **📅 Interactive Weekly Timetable**: View by **Class** (14 classes), **Teacher** (36 faculty), or **Classroom** (20 rooms, including normalized gymnasium "Sport Zal") with version switcher across 8 terms. Features automatic multi-period spanning (`colSpan = 3`) for Grade 10 & 11 elective block lessons (A10, B10, A11, B11) with dedicated visual columns for morning arrival (08:00–08:30), morning recess (10:55–11:25), lunch & recreation (13:00–14:00), and 5-min passing breaks. Includes a calibrated school schedule timeline slider (08:00 to 15:35) that smoothly pauses and fixes inside non-lesson break gaps with live countdowns, fine-tuning steppers, day-of-week simulator, and milestone presets, synchronized with active card progress indicators, live Tashkent clock (UTC+5), and interactive lesson inspector modal with accurate period timings.
